...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-20 bg-colors-black-A3 data-[state=open]:animate-overlayShow",
      className,
    )}
    {...props}
    ref={ref}
  ...
  "fixed z-50 gap-4 bg-colors-white-A12 border-gray-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-200",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full xl:w-2/6 lg:w-1/2 md:w-2/3 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
