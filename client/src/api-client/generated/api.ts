 ...
 * 
 * @export
 * @interface HttpUsersResponse
 */
export interface HttpUsersResponse {
    /**
     * 
     * @type {Array<HttpUserResponse>}
     * @memberof HttpUsersResponse
     */
    'users'?: Array<HttpUserResponse>;
}
 ...
 * @export
 */
export const BetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         ...
         */
        v1BetsBetIdPut: async (betId: string, data: HttpBetUpdateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/bets/{bet_id}`
         ...
         * @throws {RequiredError}
         */
        v1BetsGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BetsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1BetsBetIdPut(betId: string, data: HttpBetUpdateRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpBetResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1BetsBetIdPut(betId, data, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BetsApi.v1BetsBetIdPut']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async v1BetsGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpBetsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1BetsGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BetsApi.v1BetsGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
 ...
 * @export
 */
export const BetsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        v1BetsBetIdPut(betId: string, data: HttpBetUpdateRequest, options?: any): AxiosPromise<HttpBetResponse> {
            return localVarFp.v1BetsBetIdPut(betId, data, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve all bets from the current user
        ...
        v1BetsGet(options?: any): AxiosPromise<HttpBetsResponse> {
            return localVarFp.v1BetsGet(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BetsApi extends BaseAPI {
     ...
     * @memberof BetsApi
     */
    public v1BetsBetIdPut(betId: string, data: HttpBetUpdateRequest, options?: RawAxiosRequestConfig) {
        return BetsApiFp(this.configuration).v1BetsBetIdPut(betId, data, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public v1BetsGet(options?: RawAxiosRequestConfig) {
        return BetsApiFp(this.configuration).v1BetsGet(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const CommunitiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdDelete: async (communityId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdDelete', 'communityId', communityId)
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdLeavePut: async (communityId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdLeavePut', 'communityId', communityId)
            const localVarPath = `/v1/communities/{community_id}/leave`
                .replace(`{${"community_id"}}`, encodeURIComponent(String(communityId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @param {V1CommunitiesCommunityIdMembersGetDirectionEnum} direction Direction
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdMembersGet: async (communityId: string, from: number, pageSize: number, direction: V1CommunitiesCommunityIdMembersGetDirectionEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdMembersGet', 'communityId', communityId)
            // verify required parameter 'from' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdMembersGet', 'from', from)
            // verify required parameter 'pageSize' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdMembersGet', 'pageSize', pageSize)
            // verify required parameter 'direction' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdMembersGet', 'direction', direction)
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersGet: async (communityId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdPinnedUsersGet', 'communityId', communityId)
            const localVarPath = `/v1/communities/{community_id}/pinned_users`
                .replace(`{${"community_id"}}`, encodeURIComponent(String(communityId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersUserIdDelete: async (communityId: string, userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdPinnedUsersUserIdDelete', 'communityId', communityId)
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdPinnedUsersUserIdDelete', 'userId', userId)
            const localVarPath = `/v1/communities/{community_id}/pinned_users/{user_id}`
                .replace(`{${"community_id"}}`, encodeURIComponent(String(communityId)))
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersUserIdPut: async (communityId: string, userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'communityId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdPinnedUsersUserIdPut', 'communityId', communityId)
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('v1CommunitiesCommunityIdPinnedUsersUserIdPut', 'userId', userId)
            const localVarPath = `/v1/communities/{community_id}/pinned_users/{user_id}`
                .replace(`{${"community_id"}}`, encodeURIComponent(String(communityId)))
                .replace(`{${"user_id"}}`, encodeURIComponent(String(userId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesPost: async (data: HttpCommunityCreateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'data' is not null or undefined
...
export const CommunitiesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdDelete(communityId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdDelete(communityId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdJoinPost(communityId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdLeavePut(communityId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdLeavePut(communityId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdLeavePut']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdMembersGet(communityId: string, from: number, pageSize: number, direction: V1CommunitiesCommunityIdMembersGetDirectionEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityLeaderboardResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdMembersGet(communityId, from, pageSize, direction, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async v1CommunitiesCommunityIdMembersUsernameGet(communityId: string, username: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityLeaderboardResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdMembersUsernameGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdPinnedUsersGet(communityId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpUsersResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdPinnedUsersGet(communityId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdPinnedUsersGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId: string, userId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId, userId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdPinnedUsersUserIdDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId: string, userId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId, userId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesCommunityIdPinnedUsersUserIdPut']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunitiesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1CommunitiesGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CommunitiesApi.v1CommunitiesGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1CommunitiesPost(data: HttpCommunityCreateRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpCommunityResponse>> {
...
export const CommunitiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdDelete(communityId: string, options?: any): AxiosPromise<HttpCommunityResponse> {
            return localVarFp.v1CommunitiesCommunityIdDelete(communityId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Join the specified community
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdLeavePut(communityId: string, options?: any): AxiosPromise<HttpCommunityResponse> {
            return localVarFp.v1CommunitiesCommunityIdLeavePut(communityId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get members at the specified positions [from:from+pageSize)
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdMembersGet(communityId: string, from: number, pageSize: number, direction: V1CommunitiesCommunityIdMembersGetDirectionEnum, options?: any): AxiosPromise<HttpCommunityLeaderboardResponse> {
            return localVarFp.v1CommunitiesCommunityIdMembersGet(communityId, from, pageSize, direction, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get user with specified username
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersGet(communityId: string, options?: any): AxiosPromise<HttpUsersResponse> {
            return localVarFp.v1CommunitiesCommunityIdPinnedUsersGet(communityId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Remove specified user from the pinned users for a given community
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId: string, userId: string, options?: any): AxiosPromise<HttpCommunityResponse> {
            return localVarFp.v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId, userId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Add specified user to the pinned users for a given community
         ...
         * @throws {RequiredError}
         */
        v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId: string, userId: string, options?: any): AxiosPromise<HttpCommunityResponse> {
            return localVarFp.v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId, userId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve all communities the current user is part of
        ...
        v1CommunitiesGet(options?: any): AxiosPromise<HttpCommunitiesResponse> {
            return localVarFp.v1CommunitiesGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create a new community
...
export class CommunitiesApi extends BaseAPI {
     ...
     */
    public v1CommunitiesCommunityIdDelete(communityId: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdDelete(communityId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CommunitiesApi
     */
    public v1CommunitiesCommunityIdLeavePut(communityId: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdLeavePut(communityId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CommunitiesApi
     */
    public v1CommunitiesCommunityIdMembersGet(communityId: string, from: number, pageSize: number, direction: V1CommunitiesCommunityIdMembersGetDirectionEnum, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdMembersGet(communityId, from, pageSize, direction, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public v1CommunitiesCommunityIdMembersUsernameGet(communityId: string, username: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdMembersUsernameGet(communityId, username, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CommunitiesApi
     */
    public v1CommunitiesCommunityIdPinnedUsersGet(communityId: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdPinnedUsersGet(communityId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CommunitiesApi
     */
    public v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId: string, userId: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdPinnedUsersUserIdDelete(communityId, userId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CommunitiesApi
     */
    public v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId: string, userId: string, options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesCommunityIdPinnedUsersUserIdPut(communityId, userId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public v1CommunitiesGet(options?: RawAxiosRequestConfig) {
        return CommunitiesApiFp(this.configuration).v1CommunitiesGet(options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const V1CommunitiesCommunityIdMembersGetDirectionEnum = {
    Forward: 'forward',
    Backward: 'backward'
} as const;
export type V1CommunitiesCommunityIdMembersGetDirectionEnum = typeof V1CommunitiesCommunityIdMembersGetDirectionEnum[keyof typeof V1CommunitiesCommunityIdMembersGetDirectionEnum];
...
export const JobsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1JobsJobNameGet: async (jobName: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jobName' is not null or undefined
            assertParamExists('v1JobsJobNameGet', 'jobName', jobName)
            const localVarPath = `/v1/jobs/{job_name}`
...
export const JobsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1JobsJobNameGet(jobName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpJobResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1JobsJobNameGet(jobName, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['JobsApi.v1JobsJobNameGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const JobsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        v1JobsJobNameGet(jobName: string, options?: any): AxiosPromise<HttpJobResponse> {
            return localVarFp.v1JobsJobNameGet(jobName, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class JobsApi extends BaseAPI {
    ...
    public v1JobsJobNameGet(jobName: string, options?: RawAxiosRequestConfig) {
        return JobsApiFp(this.configuration).v1JobsJobNameGet(jobName, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MatchesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1MatchesGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        v1MatchesMatchIdPut: async (matchId: string, data: HttpMatchUpdateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'matchId' is not null or undefined
            assertParamExists('v1MatchesMatchIdPut', 'matchId', matchId)
            // verify required parameter 'data' is not null or undefined
            assertParamExists('v1MatchesMatchIdPut', 'data', data)
            const localVarPath = `/v1/matches/{match_id}`
...
export const MatchesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1MatchesGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpMatchesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1MatchesGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MatchesApi.v1MatchesGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async v1MatchesMatchIdPut(matchId: string, data: HttpMatchUpdateRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpMatchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1MatchesMatchIdPut(matchId, data, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MatchesApi.v1MatchesMatchIdPut']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const MatchesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        v1MatchesGet(options?: any): AxiosPromise<HttpMatchesResponse> {
            return localVarFp.v1MatchesGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update match
         ...
         * @throws {RequiredError}
         */
        v1MatchesMatchIdPut(matchId: string, data: HttpMatchUpdateRequest, options?: any): AxiosPromise<HttpMatchResponse> {
            return localVarFp.v1MatchesMatchIdPut(matchId, data, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MatchesApi extends BaseAPI {
    ...
    public v1MatchesGet(options?: RawAxiosRequestConfig) {
        return MatchesApiFp(this.configuration).v1MatchesGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MatchesApi
     */
    public v1MatchesMatchIdPut(matchId: string, data: HttpMatchUpdateRequest, options?: RawAxiosRequestConfig) {
        return MatchesApiFp(this.configuration).v1MatchesMatchIdPut(matchId, data, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PointsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1PointsPut: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export class PointsApi extends BaseAPI {
    ...
    public v1PointsPut(options?: RawAxiosRequestConfig) {
        return PointsApiFp(this.configuration).v1PointsPut(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const RootApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async rootGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpRootResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.rootGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RootApi.rootGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1UsersMeGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1UsersMeGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HttpUserResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1UsersMeGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UsersApi.v1UsersMeGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
